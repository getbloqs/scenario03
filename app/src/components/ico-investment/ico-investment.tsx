    ...
    render() {
        return (
            <div class="jumbotron">
                ...
                <p class="lead">This app allows you to invest in an ICO demo. You can use Ether on Ethereum ... Testnet to invest and get ERC-20 tokens in return.</p>
